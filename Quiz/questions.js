...
class Questions {
    ...
    nextQue = () => {
        this.allAnswers[this.count]===undefined?this.allAnswers[this.count]="You are not answered":null;
        console.log(this.allAnswers[this.count]);
        this.handle()
        this.count++;
    ...
    if(this.count===this.data.length){
        ...
        this.finalResult.innerHTML=`your score is ${this.score}/${this.count}`
    }
    }
    reload=()=>{
        location.reload()
